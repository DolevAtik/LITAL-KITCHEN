const MENU_DATA = [
    ...
    },
    {
        ...
        items: [
            { id: 's1', name: 'מטבוחה', image: 'matbuha.jpeg', options: [{ label: '250 מ"ל', price: 25 }, { label: '500 מ"ל', price: 40 }] },
            ...
            { id: 's5', name: 'כרוב אדום', image: 'red_cabbage.jpeg', options: [{ label: '250 מ"ל', price: 15 }, { label: '500 מ"ל', price: 25 }] },
            ...
            { id: 's9', name: 'סלק אדום', image: 'selek.jpeg', options: [{ label: '250 מ"ל', price: 20 }, { label: '500 מ"ל', price: 30 }] },
            { id: 's10', name: 'סלק ביצים', image: 'egg.jpeg', options: [{ label: '250 מ"ל', price: 20 }, { label: '500 מ"ל', price: 30 }] },
            { id: 's11', name: 'טחינה', image: 'thina.jpeg', options: [{ label: '250 מ"ל', price: 15 }, { label: '500 מ"ל', price: 25 }] },
            { id: 's12', name: 'סלסה', image: 'salsa.jpeg', options: [{ label: '250 מ"ל', price: 15 }, { label: '500 מ"ל', price: 25 }] },
            { id: 's13', name: 'גזר חי חריף', image: 'carrot_live.jpeg', options: [{ label: '250 מ"ל', price: 15 }, { label: '500 מ"ל', price: 25 }] },
            { id: 's14', name: 'גזר מבושל', image: 'carrot.jpeg', options: [{ label: '250 מ"ל', price: 15 }, { label: '500 מ"ל', price: 25 }] },
            { id: 's15', name: 'פלפל חריף מטוגן', image: 'pilpel_metugan.jpeg', options: [{ label: '250 מ"ל', price: 25 }, { label: '500 מ"ל', price: 35 }] },
            { id: 's16', name: 'חמוצי הבית', image: 'hamutim.jpeg', options: [{ label: '250 מ"ל', price: 15 }, { label: '500 מ"ל', price: 25 }] },
        ]
    },
    {
        categoryId: 'mains',
